...
/* ---- [START] Power Configuration -------------- */
    #define POWER_RUNTIME 21600000 // 6 hours /*300000*/                //Time to run after waking up (in ms) before going back to Deep Sleep
...
void led_handler() {
    ...
    led_fill_peripheral = true; //temporary halloween setting
...
void button_right_click(Button2& btn) {
    ...
    //enter_deep_sleep_IO_wake(); Temporarily disabled for halloween
}
